...
(function() {
  var abstractPad, cbc, depthFirst, extend, extendm, forceCallback, forceCallbackWrap, helpers, id, objorclass, parallelBucket, queue, sneakyPromise, _,
    __slice = [].slice;
  ...
  exports.squish = function() {
    var arrays, callback, maxLen, _i;
    arrays = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), callback = arguments[_i++];
    maxLen = _.reduce(arrays, (function(maxLen, array) {
      if (array.length > maxLen) {
        return array.length;
      } else {
  ...
  exports.sneakyPromise = sneakyPromise = (function() {
    function sneakyPromise(promise) {
