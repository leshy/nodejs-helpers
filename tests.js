...
(function() {
  ...
  exports.zip = function(test) {
    ...
    a = [1, 2, 3, 4];
    b = ['a', 'b', 'c'];
    test.deepEqual(helpers.zip(a, b), [[1, 'a'], [2, 'b'], [3, 'c'], [4, void 0]]);
    return test.done();
  };
  ...
  exports.once = function(test) {
    var cbcnt, cnt, testcb, testf, testfd;
    cnt = 0;
    testf = function(callback) {
      return h.wait(100, function() {
        cnt += 1;
        return callback(void 0, 1);
      });
    };
