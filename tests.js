...
(function(){
  var helpers, h, async, _, p, ph, slice$ = [].slice;
  ...
  exports.promiseRetry = function(test){
    var counter, testF, res;
    counter = 0;
    testF = function(target){
      return function(){
        var this$ = this;
        return new p(function(resolve, reject){
          counter = counter + 1;
          if (counter === target) {
            return resolve("done " + counter);
          } else {
            return reject("error " + counter);
          }
        });
      };
    };
    ...
    return ph.retry({
      delay: 5,
      times: 5
    }, testF(3)).then(function(data){
      test.equals(data, "done 3");
      counter = 0;
      return ph.retry({
        delay: 5,
        times: 2
      }, testF(3))['catch'](function(data){
